...
public class WarmupController {
	...
	public String helloGet(@RequestParam Map<String, String> allParams) {
		...
		String question = allParams.get("q");
		if (question != null && question.contains(delegationKeyword) && !allParams.containsKey(ALREADY_DELEGATED)) {
			logger.debug("Delegating " + question + " to " + "http://" + hostname + ":" + delegationPort);
			try {
				return delegatedGet("http://" + hostname + ":" + delegationPort + "/?q=" + question + "&"
